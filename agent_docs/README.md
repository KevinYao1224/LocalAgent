...
- 有界恢复：[Phase 10A 工具错误分类与模型纠正](./Phase%2010A%20-%20有界工具错误恢复实现记录.md)。
- 自检与评测：[Phase 10B 自检提示与在线对照](./Phase%2010B%20-%20自检提示与对照评测实现记录.md)。
- 权限边界：[Phase 11A 只读文件权限](./Phase%2011A%20-%20只读文件权限边界实现记录.md)。
- 固定命令边界：[Phase 11B 有界执行](./Phase%2011B%20-%20固定命令有界执行实现记录.md)。
- 精确文件授权：[Phase 11C 路径白名单](./Phase%2011C%20-%20精确文件资源授权实现记录.md)。
